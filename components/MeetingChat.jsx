                ...
                <div className="col-12 col-md-8 mb-4">
                    <div className="card text-center ms-2 p-3 h-100 meeting-card">
                        <div className="card-body d-flex flex-column align-items-center justify-content-center">
                            ...
                            <a href="#" className="btn btn-light text-primary py-1 px-4">Schedule a Meeting</a>
                        </div>
                    </div>
                </div>
                <div className="col-12 col-md-4 mb-4">
                    <div className="card text-center mx-2 p-3 h-100 bg-primary text-light">
                        <div className="card-body">
                            ...
                            <a href="#" className="btn btn-light text-primary py-1 px-4 mt-auto">Start Live Chat</a>
                        </div>
                    </div>
                </div>
            </div>
